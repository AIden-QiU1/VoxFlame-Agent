...
if (!queuePath || !decisionsPath || !outputPath) {
  throw new Error('usage: merge-mandarin-spoken-text-review-decisions --queue <queue.json> --decisions <decisions.json> --output <merged.json> [--summary <validation.json>]')
}
