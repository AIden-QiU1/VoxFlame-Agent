...
- Mobile 已升版到 `0.1.5`，Android `versionCode=6`、iOS `buildNumber=6`。当前 Linux 主机无 adb 设备、无 macOS/iOS 工具链，因此实体 Android/iPhone 的逐项点击、麦克风、蓝牙/有线路由和 Apple 安装证据仍必须由设备持有人完成，不能由 bundle 构建替代。
